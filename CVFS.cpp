...
void man(char *name)
{
    ...
    {
        printf("Description : Used to wriite into regular file\n");
        printf("Usage : write File_name\n  After this enter the data that we want to write\n");
    }
    else if(strcmp(name,"ls")== 0)
    {
        printf("Description : Used to list all information of the files\n");
        printf("Usage : ls\n");
    }
    ...
    {
        printf("ERROR : No manual enter available.\n");
    }
}
...
void DisplayHelp()
{
    ...
    printf("closeall : To close all opened the file\n");
...
void ls_file()
{
    ...
    printf("\nFile Name\tInode Number\tFile Size\tLink Couunt\n");
    printf("--------------------------------------------------------\n");
    while(temp != NULL)
    {
        if(temp -> FileType != 0)
...
void FileCreation()
{
    ...
    if(SUPERBLOCKobj.FreeInodes == MAXINODE)
    {
        printf("There is no file creataion\n");
        return;
    }
    ...
    printf("All files gets successfully created on Hard Disk\n");  
}
